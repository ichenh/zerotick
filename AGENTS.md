...
ZeroTick 是面向普通用户的 Windows 设备与系统故障诊断工具（Tauri 2）。核心能力：网络、音频、可移动存储、蓝牙、设备驱动、BSOD 与端口诊断；安全的一键修复；托盘监控、原生通知、历史导出；普通/高级模式分层；37 种经过完整校验的界面语言（英语离线回退 + 36 个按需语言包）。

## 版本策略

```
v0.2.6  ← 当前版本
v0.2.7  ← 下一版常规开发（patch）
…
