  ...
  "zh-TW": {
    ...
    "diag": {
      ...
      "repair": {
        ...
        "idle": "將修復音訊、藍牙支援與隨插即用服務，並掃描 USB 省電設定",
        "loading": "執行中…",
  ...
  "ja": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "スキャン",
        "desc": "Bluetooth アダプターと Bluetooth サポート サービスを確認",
        "idle": "「スキャン」をクリックして開始",
        "loading": "スキャン中…",
        "ok": "正常",
        "warn": "問題あり",
      ...
      "repair": {
        ...
        "idle": "オーディオ、Bluetooth サポート、プラグ アンド プレイの各サービスを修復し、USB 電源設定をスキャンします",
        "loading": "実行中…",
  ...
  "ko": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "검사",
        "desc": "Bluetooth 어댑터 및 Bluetooth 지원 서비스 확인",
        "idle": "「검사」를 클릭하여 시작",
        "loading": "검사 중…",
        "ok": "정상",
        "warn": "문제 발견",
      ...
      "repair": {
        ...
        "idle": "오디오, Bluetooth 지원 및 플러그 앤 플레이 서비스를 복구하고 USB 전원 설정을 검사합니다",
        "loading": "실행 중…",
  ...
  "de": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Scannen",
        "desc": "Bluetooth-Adapter und Bluetooth-Unterstützungsdienst prüfen",
      ...
      "repair": {
        ...
        "idle": "Repariert Audio-, Bluetooth-Unterstützungs- und Plug-and-Play-Dienste und prüft USB-Energieeinstellungen",
  ...
  "fr": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Analyser",
        "desc": "Vérifier l’adaptateur Bluetooth et le service de prise en charge Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Répare les services audio, de prise en charge Bluetooth et Plug-and-Play, puis analyse l’alimentation USB",
        "loading": "En cours…",
  ...
  "es": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Escanear",
        "desc": "Comprobar el adaptador Bluetooth y el servicio de compatibilidad con Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Repara los servicios de audio, compatibilidad con Bluetooth y Plug and Play, y analiza la energía USB",
        "loading": "Ejecutando…",
  ...
  "pt-BR": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Verificar",
        "desc": "Verificar o adaptador Bluetooth e o Serviço de Suporte a Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Repara serviços de áudio, suporte a Bluetooth e Plug and Play e verifica a energia USB",
        "loading": "Executando…",
  ...
  "ru": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Сканировать",
        "desc": "Проверить адаптер Bluetooth и службу поддержки Bluetooth",
        "idle": "Нажмите «Сканировать» для начала",
        "loading": "Сканирование…",
        "ok": "В норме",
        "warn": "Обнаружены проблемы",
        "unknown": "Неизвестно",
        "radio": "Адаптер Bluetooth",
        "radioCount": "{n} устр.",
        "issues": "Проблемы",
      ...
      "repair": {
        ...
        "idle": "Восстанавливает службы аудио, поддержки Bluetooth и Plug and Play и проверяет питание USB",
        "loading": "Выполнение…",
  ...
  "ar": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "فحص",
        "desc": "التحقق من محوّل Bluetooth وخدمة دعم Bluetooth",
        "idle": "انقر فحص للبدء",
        "loading": "جارٍ الفحص…",
        "ok": "سليم",
        "warn": "تم العثور على مشاكل",
        "unknown": "غير معروف",
        "radio": "محوّل Bluetooth",
        "radioCount": "{n} جهاز",
        "issues": "المشاكل",
        "noIssues": "لا مشاكل"
      },
      ...
      "repair": {
        ...
        "idle": "يصلح خدمات الصوت ودعم Bluetooth والتوصيل والتشغيل ويفحص إعدادات طاقة USB",
  ...
  "hi": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "स्कैन",
        "desc": "Bluetooth अडैप्टर और Bluetooth सहायता सेवा जाँचें",
        "idle": "शुरू करने के लिए स्कैन पर क्लिक करें",
        "loading": "स्कैन हो रहा है…",
        "ok": "स्वस्थ",
        "warn": "समस्याएँ मिलीं",
        "unknown": "अज्ञात",
        "radio": "Bluetooth अडैप्टर",
        "radioCount": "{n} डिवाइस",
        "issues": "समस्याएँ",
      ...
      "repair": {
        ...
        "idle": "ऑडियो, Bluetooth सहायता और प्लग एंड प्ले सेवाओं की मरम्मत करता है और USB पावर सेटिंग्स स्कैन करता है",
        "loading": "चल रहा है…",
  ...
  "it": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Scansiona",
        "desc": "Verifica l’adattatore Bluetooth e il servizio di supporto Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Ripara i servizi audio, di supporto Bluetooth e Plug and Play e analizza l’alimentazione USB",
  ...
  "nl": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Scannen",
        "desc": "Controleer de Bluetooth-adapter en Bluetooth-ondersteuningsservice",
      ...
      "repair": {
        ...
        "idle": "Herstelt audio-, Bluetooth-ondersteunings- en Plug-and-Play-services en scant USB-energie-instellingen",
        "loading": "Uitvoeren…",
  ...
  "pl": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Skanuj",
        "desc": "Sprawdź adapter Bluetooth i usługę obsługi Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Naprawia usługi audio, obsługi Bluetooth i Plug and Play oraz skanuje ustawienia zasilania USB",
        "loading": "Wykonywanie…",
  ...
  "tr": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Tara",
        "desc": "Bluetooth bağdaştırıcısını ve Bluetooth Destek Hizmetini kontrol et",
        "idle": "Başlamak için Tara'ya tıklayın",
        "loading": "Taranıyor…",
        "ok": "Sağlıklı",
        "warn": "Sorun bulundu",
        "unknown": "Bilinmiyor",
        "radio": "Bluetooth bağdaştırıcısı",
        "radioCount": "{n} cihaz",
        "issues": "Sorunlar",
        "noIssues": "Sorun yok"
      },
      ...
      "repair": {
        ...
        "idle": "Ses, Bluetooth desteği ve Tak ve Kullan hizmetlerini onarır ve USB güç ayarlarını tarar",
        "loading": "Çalışıyor…",
  ...
  "vi": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Quét",
        "desc": "Kiểm tra bộ điều hợp Bluetooth và Dịch vụ hỗ trợ Bluetooth",
        "idle": "Nhấp Quét để bắt đầu",
        "loading": "Đang quét…",
        "ok": "Khỏe mạnh",
        "warn": "Phát hiện vấn đề",
        "unknown": "Không rõ",
        "radio": "Bộ điều hợp Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Sửa các dịch vụ âm thanh, hỗ trợ Bluetooth và Cắm là Chạy, đồng thời quét nguồn USB",
        "loading": "Đang chạy…",
  ...
  "th": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "สแกน",
        "desc": "ตรวจสอบอะแดปเตอร์ Bluetooth และบริการสนับสนุน Bluetooth",
        "idle": "คลิกสแกนเพื่อเริ่ม",
        "loading": "กำลังสแกน…",
        "ok": "ปกติ",
        "warn": "พบปัญหา",
        "unknown": "ไม่ทราบ",
        "radio": "อะแดปเตอร์ Bluetooth",
      ...
      "repair": {
        ...
        "idle": "ซ่อมแซมบริการเสียง การสนับสนุน Bluetooth และ Plug and Play พร้อมสแกนการตั้งค่าพลังงาน USB",
        "loading": "กำลังทำงาน…",
  ...
  "id": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Pindai",
        "desc": "Periksa adaptor Bluetooth dan Layanan Dukungan Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Memperbaiki layanan audio, dukungan Bluetooth, dan Plug and Play serta memindai daya USB",
        "loading": "Menjalankan…",
  ...
  "cs": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Skenovat",
        "desc": "Zkontrolovat adaptér Bluetooth a službu podpory Bluetooth",
        "idle": "Klikněte na Skenovat pro začátek",
        "loading": "Skenování…",
        "ok": "V pořádku",
        "warn": "Nalezeny problémy",
        "unknown": "Neznámé",
        "radio": "Adaptér Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Opraví služby zvuku, podpory Bluetooth a Plug and Play a zkontroluje napájení USB",
        "loading": "Probíhá…",
  ...
  "da": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Scan",
        "desc": "Tjek Bluetooth-adapter og Bluetooth-supporttjeneste",
      ...
      "repair": {
        ...
        "idle": "Reparerer lyd-, Bluetooth-support- og Plug and Play-tjenester og scanner USB-strømindstillinger",
        "loading": "Kører…",
  ...
  "fi": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Skannaa",
        "desc": "Tarkista Bluetooth-sovitin ja Bluetooth-tukipalvelu",
      ...
      "repair": {
        ...
        "idle": "Korjaa ääni-, Bluetooth-tuki- ja Plug and Play -palvelut ja tarkistaa USB-virta-asetukset",
        "loading": "Suoritetaan…",
  ...
  "nb": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Skann",
        "desc": "Sjekk Bluetooth-adapter og Bluetooth-støttetjeneste",
      ...
      "repair": {
        ...
        "idle": "Reparerer lyd-, Bluetooth-støtte- og Plug and Play-tjenester og skanner USB-strøminnstillinger",
        "loading": "Kjører…",
  ...
  "sv": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Skanna",
        "desc": "Kontrollera Bluetooth-adapter och Bluetooth-supporttjänst",
      ...
      "repair": {
        ...
        "idle": "Reparerar ljud-, Bluetooth-support- och Plug and Play-tjänster och skannar USB-ströminställningar",
        "loading": "Kör…",
  ...
  "uk": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Сканувати",
        "desc": "Перевірити адаптер Bluetooth і службу підтримки Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Відновлює служби аудіо, підтримки Bluetooth і Plug and Play та перевіряє живлення USB",
        "loading": "Виконання…",
  ...
  "he": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "סריקה",
        "desc": "בדיקת מתאם Bluetooth ושירות התמיכה ב-Bluetooth",
        "idle": "לחץ סריקה כדי להתחיל",
        "loading": "סורק…",
        "ok": "תקין",
        "warn": "נמצאו בעיות",
        "unknown": "לא ידוע",
        "radio": "מתאם Bluetooth",
      ...
      "repair": {
        ...
        "idle": "מתקן שירותי שמע, תמיכה ב-Bluetooth והכנס-הפעל וסורק הגדרות צריכת חשמל של USB",
        "loading": "מריץ…",
  ...
  "ms": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Imbas",
        "desc": "Semak penyesuai Bluetooth dan Perkhidmatan Sokongan Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Membaiki perkhidmatan audio, sokongan Bluetooth dan Plug and Play serta mengimbas kuasa USB",
        "loading": "Menjalankan…",
  ...
  "ro": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Scanează",
        "desc": "Verifică adaptorul Bluetooth și Serviciul de asistență Bluetooth",
      ...
      "repair": {
        ...
        "idle": "Repară serviciile audio, de asistență Bluetooth și Plug and Play și scanează alimentarea USB",
        "loading": "Se execută…",
  ...
  "hu": {
    ...
    "diag": {
      "bluetooth": {
        "title": "Bluetooth",
        "scan": "Vizsgálat",
        "desc": "A Bluetooth-adapter és a Bluetooth-támogatási szolgáltatás ellenőrzése",
      ...
      "repair": {
        ...
        "idle": "Javítja a hang-, Bluetooth-támogatási és Plug and Play szolgáltatásokat, és vizsgálja az USB tápellátást",
        "loading": "Futtatás…",
...
// Shared user-facing terminology for the current toolkit pages. Keeping these
// names separate prevents Windows implementation terms such as "radio" and
// "bthserv" from leaking into the UI when a locale uses a legacy page bundle.
export const terminology = {
  "zh-TW": { bluetoothAdapter: "藍牙介面卡", bluetoothSupportService: "藍牙支援服務（bthserv）" },
  ja: { bluetoothAdapter: "Bluetooth アダプター", bluetoothSupportService: "Bluetooth サポート サービス（bthserv）" },
  ko: { bluetoothAdapter: "Bluetooth 어댑터", bluetoothSupportService: "Bluetooth 지원 서비스(bthserv)" },
  de: { bluetoothAdapter: "Bluetooth-Adapter", bluetoothSupportService: "Bluetooth-Unterstützungsdienst (bthserv)" },
  fr: { bluetoothAdapter: "Adaptateur Bluetooth", bluetoothSupportService: "Service de prise en charge Bluetooth (bthserv)" },
  es: { bluetoothAdapter: "Adaptador Bluetooth", bluetoothSupportService: "Servicio de compatibilidad con Bluetooth (bthserv)" },
  "pt-BR": { bluetoothAdapter: "Adaptador Bluetooth", bluetoothSupportService: "Serviço de Suporte a Bluetooth (bthserv)" },
  ru: { bluetoothAdapter: "Адаптер Bluetooth", bluetoothSupportService: "Служба поддержки Bluetooth (bthserv)" },
  ar: { bluetoothAdapter: "محوّل Bluetooth", bluetoothSupportService: "خدمة دعم Bluetooth ‏(bthserv)" },
  hi: { bluetoothAdapter: "Bluetooth अडैप्टर", bluetoothSupportService: "Bluetooth सहायता सेवा (bthserv)" },
  it: { bluetoothAdapter: "Adattatore Bluetooth", bluetoothSupportService: "Servizio di supporto Bluetooth (bthserv)" },
  nl: { bluetoothAdapter: "Bluetooth-adapter", bluetoothSupportService: "Bluetooth-ondersteuningsservice (bthserv)" },
  pl: { bluetoothAdapter: "Adapter Bluetooth", bluetoothSupportService: "Usługa obsługi Bluetooth (bthserv)" },
  tr: { bluetoothAdapter: "Bluetooth bağdaştırıcısı", bluetoothSupportService: "Bluetooth Destek Hizmeti (bthserv)" },
  vi: { bluetoothAdapter: "Bộ điều hợp Bluetooth", bluetoothSupportService: "Dịch vụ hỗ trợ Bluetooth (bthserv)" },
  th: { bluetoothAdapter: "อะแดปเตอร์ Bluetooth", bluetoothSupportService: "บริการสนับสนุน Bluetooth (bthserv)" },
  id: { bluetoothAdapter: "Adaptor Bluetooth", bluetoothSupportService: "Layanan Dukungan Bluetooth (bthserv)" },
  cs: { bluetoothAdapter: "Adaptér Bluetooth", bluetoothSupportService: "Služba podpory Bluetooth (bthserv)" },
  da: { bluetoothAdapter: "Bluetooth-adapter", bluetoothSupportService: "Bluetooth-supporttjeneste (bthserv)" },
  fi: { bluetoothAdapter: "Bluetooth-sovitin", bluetoothSupportService: "Bluetooth-tukipalvelu (bthserv)" },
  nb: { bluetoothAdapter: "Bluetooth-adapter", bluetoothSupportService: "Bluetooth-støttetjeneste (bthserv)" },
  sv: { bluetoothAdapter: "Bluetooth-adapter", bluetoothSupportService: "Bluetooth-supporttjänst (bthserv)" },
  uk: { bluetoothAdapter: "Адаптер Bluetooth", bluetoothSupportService: "Служба підтримки Bluetooth (bthserv)" },
  he: { bluetoothAdapter: "מתאם Bluetooth", bluetoothSupportService: "שירות תמיכה ב-Bluetooth ‏(bthserv)" },
  ms: { bluetoothAdapter: "Penyesuai Bluetooth", bluetoothSupportService: "Perkhidmatan Sokongan Bluetooth (bthserv)" },
  ro: { bluetoothAdapter: "Adaptor Bluetooth", bluetoothSupportService: "Serviciul de asistență Bluetooth (bthserv)" },
  hu: { bluetoothAdapter: "Bluetooth-adapter", bluetoothSupportService: "Bluetooth-támogatási szolgáltatás (bthserv)" },
};
